const modalTemplates={
    "modal-start":
    `<p>El juego muestra en pantalla las puntuaciones obtenidas por el usuario, nombre del jugador, y el tiempo que tienes para matar a los zombies. Los zombies aparecerán de forma aleatoria por pantalla con una velocidad de 700 milisegundos.</p>
    <p>Al terminar el tiempo aparecerá un cuadro informativo donde te dirá <b>"Nombre del jugador, ¡Se acabó el tiempo!" y tu puntuación</b> donde te mostrará 3 botones. Volver a jugar y ver puntuaciones donde verás las puntuaciones de otros usuarios e Ir al menú.</p>

    <div class="images-container">
        <img loading="lazy" src="./images/game-screen.png" class="img-border img" alt="">
        <img loading="lazy" src="./images/game-screen-2.png" class="img-border img" alt="">
        <img loading="lazy" src="./images/modal-game-screen.png" class="img-border img" alt="">
    </div>
    `,
    "modal-scores":
    `
    ...
    `,
    "modal-closed-session":
    `<p>Cerrar sesión: Cierra la Activity Menú para volver a la pantalla de inicio donde podrá hacer un nuevo registro o volver a iniciar sesión.</p>
    <div class="images-container">
        <img loading="lazy" src="./images/modal-close-session-screen.png" class="img-border img" alt="">
    </div>
    `
}
document.addEventListener("DOMContentLoaded",_=>{
    ...
    document.addEventListener("click",(e)=>{
        ...
        if(e.target.matches("#btn-acept")) document.body.firstChild.remove();
        ...
        <div class="modal-window-welcome">
            <div class="modal-window-content">
                <hr>
                    <article>
                    ${modalTemplates[e.target.className]}
                    </article>
                    </br>
                    <hr>
                <button id="btn-acept">Aceptar</button>
            </div>
        </div>
        ` ; 
        document.body.insertAdjacentHTML("afterbegin",template_modal_window);         
    });
})
